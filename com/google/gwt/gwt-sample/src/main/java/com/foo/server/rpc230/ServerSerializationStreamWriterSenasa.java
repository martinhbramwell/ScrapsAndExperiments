 ...
 */
final class ServerSerializationStreamWriterSenasa extends AbstractSerializationStreamWriter
{
    ...
    private enum VectorWriter
    {
        ...
        {
            @Override
            void write( ServerSerializationStreamWriterSenasa stream, Object instance )
            {
        ...
        {
            @Override
            void write( ServerSerializationStreamWriterSenasa stream, Object instance ) throws SerializationException
            {
        ...
        abstract void write( ServerSerializationStreamWriterSenasa stream, Object instance ) throws SerializationException;
    }
    ...
    public ServerSerializationStreamWriterSenasa( SerializationPolicy serializationPolicy )
    {
    ...
    protected String getObjectTypeSignature( Object instance ) throws SerializationException
    {
        ...
        {
            if( serializationPolicy instanceof TypeNameObfuscator ) { return ( ( TypeNameObfuscator )serializationPolicy ).getTypeIdForClass( clazz ); }
    ...
    private void serializeImpl( Object instance, Class<?> instanceClass ) throws SerializationException
    {
        ...
        if( customSerializer != null )
        {
            ...
            CustomFieldSerializer<Object> customFieldSerializer = ( CustomFieldSerializer<Object> )SerializabilityUtil.loadCustomFieldSerializer( customSerializer );
    ...
    public void setValueWriter( Class<Object> clazz, ValueWriter writer )
    {
